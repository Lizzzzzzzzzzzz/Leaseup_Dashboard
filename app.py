...
with col1:
    ...
    fig.update_layout(
        ...
        plot_bgcolor='#161b22', paper_bgcolor='#161b22', font_color='#e6edf3', height=300, showlegend=True,
...
with col2:
    ...
    fig2.update_layout(
        ...
        plot_bgcolor='#161b22', paper_bgcolor='#161b22', font_color='#e6edf3',
...
with c2:
    ...
    fig4.update_layout(
        ...
        plot_bgcolor='#161b22', paper_bgcolor='#161b22', font_color='#e6edf3', height=300, showlegend=False,
